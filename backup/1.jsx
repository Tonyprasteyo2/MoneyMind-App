                    ...
                    <div className="bg-white shadow-md rounded-xl p-3 sm:p-6 mx-auto container">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <button
                                ...
                                className={`flex flex-col items-center justify-center border-rounded-xl p-2 transition-all cursor-pointer ${mode === "manual"
                            ...
                            <button
                                type="button"
                                onClick={() => setMode("ocr")}
                                className={`flex flex-col items-center justify-center border-rounded-xl p-2 transition-all cursor-pointer ${mode === "ocr"
                                        ? "bg-blue-600 text-white shadow-lg"
                                        : "bg-gray-100 text-gray-700 hover:bg-gray-200"
                                    }`}
                            >
                            ...
                            <AnimatePresence>
                                {animatedList.map((result) => {
                                    const IconKategori = icons.find(
                                        (i) =>
                                            i.name === result.list_kategori.icon
                                    ) || {
                                        icon: LuWalletCards,
                                        color: "text-gray-400",
                                    };
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <span
                                                className={`font-semibold ${result.type === "pemasukan"
                                                        ? "text-green-600"
                                                        : "text-red-600"
                                                    }`}
                                            >
                        ...
                        <div className="grid grid-cols-6 gap-3 mb-6">
                            {icons.map(({ name, icon: Icon, color }, i) => (
                                <button
                                    ...
                                    type="button"
                                    className={`text-2xl p-2 rounded-lg transition cursor-pointer ${selectedIcon === name
