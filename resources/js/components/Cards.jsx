...
import { TransaksiUser } from "./TransaksiList";
    ...
    <>
          ...
          <div className="bg-white p-4 rounded-xl shadow-xl flex items-center justify-between">
            <div>
              ...
              <h2 className="text-xl font-bold">
                {loading ? "Loading..." : formatRupiah(totalTransaksi)}
              </h2>
            </div>
          ...
          <div className="bg-white p-4 rounded-xl shadow-xl flex items-center justify-between w-auto">
            <div>
              ...
              <h2 className="text-xl font-bold text-green-600">
                {loading ? "Loading..." : formatRupiah(totalPemasukan)}
              </h2>
            </div>
          ...
          <div className="bg-white p-4 rounded-xl shadow-xl flex items-center justify-between">
            <div>
              ...
              <h2 className="text-xl font-bold text-red-600">
                {loading ? "Loading..." : formatRupiah(totalPengeluaran)}
              </h2>
            </div>
      ...
      <div className="p-3 md:p-6 lg:p-7">
        <form onSubmit={(e) => tambahTransaksi(e)}>
          <div className="bg-white shadow-md rounded-xl p-3 sm:p-6 mx-auto container">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              >
                <FaEdit className="text-2xl mb-2" />
                <span className="font-medium">Scan Foto </span>
                <p className="text-sm opacity-80">
            ...
            {mode === "manual" && (
              <div className="animate-fadeIn mt-2">
                ...
                <div className="mt-4">
                  ...
                  <textarea
                    name="note"
                    className="w-full focus:outline-none focus:ring-2 focus:ring-indigo-500 border rounded-lg p-3 h-30"
                ...
                <div className="mt-3">
                  ...
                  >
                    ...
                    {kategoriAll.map((key) => (
                      <option key={key.kategori_id} value={key.kategori_id}>
                ...
                <div>
                  {!previewImage ? (
                    <>
                      {!tipeMode ? (
                        <div className="text-center">
                          ...
                          <p className="text-sm text-gray-600 mb-4">
                            Pilih cara untuk memindai struk transaksi Anda
                          </p>

                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <label
                              onClick={() => setTipeMode("camera")}
                      ...
                      {tipeMode === "camera" && (
                        <ViewCamera
                          setResultOcr={setResultOcr}
                          setTipeMode={setTipeMode}
                          setPreviewImage={setPreviewImage}
                          setProsesLoading={setProsesLoading}
                        />
                      )}
                    </>
                  ) : (
                      ...
                      {prosesLoading ? (
                        <div className="flex flex-col items-center justify-center py-6">
                          ...
                          <p className="text-indigo-600 font-semibold animate-pulse">
                            Harap menunggu,sedang membaca file..
                          </p>
                        </div>
                      ) : (
                        <>
      ...
      <div className="overscroll-auto overflow-auto h-100">
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-8 text-gray-500">
            ...
            />
            <p className="mt-3 text-sm">Memuat transaksi...</p>
          </div>
          ...
          <div className="flex flex-col items-center justify-center text-gray-500 py-6">
            ...
            <p className="text-center text-sm sm:text-base">
              Belum ada transaksi. Yuk tambahkan transaksi Anda
            </p>
          </div>
        ) : (
          ...
          <ul className="divide-y divide-gray-200">
            <AnimatePresence>
              {animatedList.map((result) => {
                const IconKategori =
                  icons.find((i) => i.name === result.list_kategori.icon) || {
                    icon: LuWalletCards,
                    color: "text-gray-400",
                  };
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      {editMode && (
                        <input
                          ...
                          onChange={() => showModalCheckBox(result)}
                        />
                      )}
                      <div className="w-10 h-10 flex items-center justify-center bg-gray-100 rounded-full">
                        <Icon className={`text-2xl ${IconKategori.color}`} />
                      </div>
                      <div>
                    ...
                    >
                      {result.type === "pemasukan" ? "+" : "-"}
                      {formatRupiah(parseInt(result.amount))}
                    </span>
                  </motion.li>
                );
              })}
      ...
      {showPopup && (
        <div className="fixed inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white w-full max-w-md rounded-2xl p-6 relative">
            ...
            />
            <p className="text-sm font-medium text-gray-600 mb-2">Pilih Ikon</p>
